...
description: Corrige automaticamente problemas encontrados pela revisão de código no REVIEW.md. Inicia agente de correção, commita cada correção atomicamente e gera resumo REVIEW-FIX.md.
---
