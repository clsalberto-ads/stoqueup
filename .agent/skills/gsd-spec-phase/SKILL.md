---
name: gsd-spec-phase
description: Refinamento socrático de especificações — esclarece O QUE uma fase entrega com pontuação de ambiguidade antes da discussão da fase. Produz um SPEC.md com requisitos falseáveis bloqueados antes que as decisões de implementação comecem.
---
