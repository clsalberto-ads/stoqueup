---
name: gsd-forensics
description: Investigação pós-morte para fluxos de trabalho GSD que falharam — analisa histórico do git, artefatos e estado para diagnosticar o que deu errado
---
