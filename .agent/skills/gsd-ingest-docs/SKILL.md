...
description: Escaneia um repositório por ADRs, PRDs, SPECs e DOCs mistos e inicializa ou mescla a configuração completa do .planning/ a partir deles. Classifica cada documento em paralelo, sintetiza um contexto consolidado com um relatório de conflitos e encaminha para novo projeto ou mesclagem de marco, dependendo se o .planning/ já existe.
---
