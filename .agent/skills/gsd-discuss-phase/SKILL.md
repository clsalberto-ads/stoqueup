...
description: Coleta contexto da fase através de questionamento adaptativo antes do planejamento. Use --all para pular a seleção de área e discutir todas as áreas cinzentas interativamente. Use --auto para pular perguntas interativas (o agente escolhe padrões recomendados). Use --chain para discussão interativa seguida de planejamento+execução automáticos. Use --power para geração de perguntas em massa em uma interface baseada em arquivo (responda no seu próprio ritmo).
---
